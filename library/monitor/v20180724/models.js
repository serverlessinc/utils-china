...
注意：此字段可能返回 null，表示取不到有效值。
  ...
  deserialize(params) {
    ...
    if (params.Callback) {
      const obj = new DescribePolicyGroupInfoCallback()
...
class MetricSet extends AbstractModel {
  ...
  deserialize(params) {
    ...
    if (params.Meaning) {
      const obj = new MetricObjectMeaning()
...
注意：此字段可能返回 null，表示取不到有效值。
  ...
  deserialize(params) {
    ...
    if (params.InstanceGroup) {
      const obj = new DescribeBindingPolicyObjectListInstanceGroup()
      obj.deserialize(params.InstanceGroup)
      this.InstanceGroup = obj
    }
    this.RequestId = 'RequestId' in params ? params.RequestId : null
...
注意：此字段可能返回 null，表示取不到有效值。
  ...
  deserialize(params) {
    ...
    if (params.OverView) {
      const obj = new DescribeProductEventListOverView()
